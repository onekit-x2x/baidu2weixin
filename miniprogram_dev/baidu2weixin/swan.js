...
var _CameraContext = __webpack_require__(12);

var _CameraContext2 = _interopRequireDefault(_CameraContext);

var _InnerAudioContext = __webpack_require__(13);

var _InnerAudioContext2 = _interopRequireDefault(_InnerAudioContext);

var _VideoContext = __webpack_require__(14);

var _VideoContext2 = _interopRequireDefault(_VideoContext);

var _LivePlayerContext = __webpack_require__(15);
...
var swan = function () {
  ...
  swan.canIUse = function canIUse(object) {
    return true;
  };
  ...
  swan.offPageNotFound = function offPageNotFound(object) {
    return wx.offPageNotFound(object);
  };

  swan.onPageNotFound = function onPageNotFound(object) {
    return wx.onPageNotFound(object);
  };

  swan.offError = function offError(object) {
    return wx.offError(object);
  };

  swan.onError = function onError(object) {
    return wx.onError(object);
  };

  swan.offAppShow = function offAppShow(object) {
    return wx.offAppShow(object);
  };

  swan.onAppShow = function onAppShow(object) {
    return wx.onAppShow(object);
  };

  swan.offAppHide = function offAppHide(object) {
    return wx.offAppHide(object);
  };

  swan.onAppHide = function onAppHide(object) {
  ...
  swan.createCameraContext = function createCameraContext(cameraId, ui) {
  ...
  swan.createInnerAudioContext = function createInnerAudioContext(audioId, ui) {
  ...
  swan.createLivePlayerContext = function createLivePlayerContext(playerId, ui) {
  ...
  swan.createVideoContext = function createVideoContext(videoId, ui) {
  ...
  swan.onBeaconServiceChange = function onBeaconServiceChange(object) {
    return wx.onBeaconServiceChange(object);
  };

  swan.onBeaconUpdate = function onBeaconUpdate(object) {
  ...
  swan.onWifiConnected = function onWifiConnected(object) {
    return wx.onWifiConnected(object);
  };

  swan.onGetWifiList = function onGetWifiList(object) {
  ...
  swan.onDeviceMotionChange = function onDeviceMotionChange(object) {
  ...
  swan.onBLEConnectionStateChange = function onBLEConnectionStateChange(object) {
    return wx.onBLEConnectionStateChange(object);
  };

  swan.onBLECharacteristicValueChange = function onBLECharacteristicValueChange(object) {
  ...
  swan.stopBluetoothDevicesDiscovery = function stopBluetoothDevicesDiscovery(object) {/* return wx.stopBluetoothDevicesDiscovery(object); */};
  ...
  swan.openBluetoothAdapter = function openBluetoothAdapter(object) {/* return wx.openBluetoothAdapter(object); */};

  swan.onBluetoothDeviceFound = function onBluetoothDeviceFound(object) {
    return wx.onBluetoothDeviceFound(object);
  };

  swan.onBluetoothAdapterStateChange = function onBluetoothAdapterStateChange(object) {
  ...
  swan.onHCEMessage = function onHCEMessage(object) {
  ...
  swan.onUserCaptureScreen = function onUserCaptureScreen(object) {
  ...
  swan.onBackgroundAudioStop = function onBackgroundAudioStop(object) {
    return wx.onBackgroundAudioStop(object);
  };

  swan.onBackgroundAudioPause = function onBackgroundAudioPause(object) {
    return wx.onBackgroundAudioPause(object);
  };

  swan.onBackgroundAudioPlay = function onBackgroundAudioPlay(object) {
  ...
  swan.onSocketError = function onSocketError(object) {
    return wx.onSocketError(object);
  };

  swan.onSocketMessage = function onSocketMessage(object) {
    return wx.onSocketMessage(object);
  };

  swan.onSocketClose = function onSocketClose(object) {
    return wx.onSocketClose(object);
  };

  swan.onSocketOpen = function onSocketOpen(object) {
    return wx.connectSocket(object);
  };
  ...
  swan.offLocalServiceResolveFail = function offLocalServiceResolveFail(object) {
    return wx.offLocalServiceResolveFail(object);
  };

  swan.onLocalServiceResolveFail = function onLocalServiceResolveFail(object) {
    return wx.onLocalServiceResolveFail(object);
  };

  swan.offLocalServiceDiscoveryStop = function offLocalServiceDiscoveryStop(object) {
    return wx.offLocalServiceDiscoveryStop(object);
  };

  swan.onLocalServiceDiscoveryStop = function onLocalServiceDiscoveryStop(object) {
    return wx.onLocalServiceDiscoveryStop(object);
  };

  swan.offLocalServiceLost = function offLocalServiceLost(object) {
    return wx.offLocalServiceLost(object);
  };

  swan.onLocalServiceLost = function onLocalServiceLost(object) {
    return wx.onLocalServiceLost(object);
  };

  swan.offLocalServiceFound = function offLocalServiceFound(object) {
    return wx.offLocalServiceFound(object);
  };

  swan.onLocalServiceFound = function onLocalServiceFound(object) {
  ...
  swan.getOpenData = function getOpenData(object) {
  ...
  swan.offWindowResize = function offWindowResize(object) {
    return wx.offWindowResize(object);
  };

  swan.onWindowResize = function onWindowResize(object) {
  ...
  swan.createARCameraContext = function createARCameraContext(object) {
